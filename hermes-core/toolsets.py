...
#
# Nightwing strip: trimmed to the tools that survive the Phase 1 cut-down
# (see hermes-core strip notes). Removed categories — web, desktop-GUI
# affordances, cloud image/video generation, browser automation, TTS, Home
# Assistant, kanban, computer-use — had their backing tools/*.py and
# plugins/* implementations deleted; referencing their names here would
# just be dead entries.
_HERMES_CORE_TOOLS = [
    # Terminal + process management (sandboxed via Docker backend)
    "terminal", "process",
    # File manipulation
    "read_file", "write_file", "patch", "search_files",
    # Vision (local multimodal model — used by the OCR/multimodal plugin's
    # vision-fallback path)
    "vision_analyze", "video_analyze",
    # Skills
    "skills_list", "skill_view", "skill_manage",
    # Planning & memory (local file-based)
    "todo", "memory",
